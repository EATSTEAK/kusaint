...
class TimeTableTests {
    ...
    @Test
    fun retrieveOneRequiredElectiveTest() {
        runBlockingTest {
    ...
    @Test
    fun retrieveAllRequiredElectivesTest() {
        runBlockingTest {
    ...
    @Test
    fun retrieveOneOptionalElectiveTest() {
        runBlockingTest {
    ...
    @Test
    fun retrieveAllOptionalElectivesTest() {
        runBlockingTest {
